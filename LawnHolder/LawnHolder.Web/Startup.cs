...
public class Startup
{
    ...
    {
        var syncfusionKey = _configuration["SyncfusionLicenseKey"];
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "LawnHolder.Web API", Version = "v1" });
